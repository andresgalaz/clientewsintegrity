...
public class ServiceLocator extends org.apache.axis.client.Service implements ar.com.libertyargentina.Service {
    private static final long serialVersionUID = -9146410316437558882L;
    ...
    private java.lang.String ServiceSoap_address = "http://localhost/LibertyWS/service.asmx";
    ...
    public ar.com.libertyargentina.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ar.com.libertyargentina.ServiceSoapStub _stub = new ar.com.libertyargentina.ServiceSoapStub( portAddress, this );
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ar.com.libertyargentina.ServiceSoap.class.isAssignableFrom( serviceEndpointInterface )) {
                ar.com.libertyargentina.ServiceSoapStub _stub = new ar.com.libertyargentina.ServiceSoapStub( new java.net.URL( ServiceSoap_address ), this );
                _stub.setPortName( getServiceSoapWSDDServiceName() );
                return _stub;
            }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName( "http://libertyargentina.com.ar/", "Service" );
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add( new javax.xml.namespace.QName( "http://libertyargentina.com.ar/", "ServiceSoap" ) );
        }
